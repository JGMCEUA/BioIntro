# Getting help with `BioIntro`

Thank you for using `BioIntro`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/BioIntro`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/BioIntro),
...
[search issues and pull requests](https://github.com/JGMCEUA/BioIntro/issues)
